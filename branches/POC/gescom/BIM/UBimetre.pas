...
function ConstitueDocument(NaturePiece : string; Repertoire : string; TOBL : TOB; RAPPORT: THRichEditOLE) : boolean;
  ...
  function AjouteParagraphe (TOBpere: TOB; TX :TDataTransport ; Numerotation,Libelle : string) : TOB;
  var NIv : Integer;
      Indice : Integer;
      TOBL : TOB;
  begin
  ...
  procedure AjouteLigneDet (TOBpere : TOB; TX :TDataTransport ; CodeArticle,CodeBiblio,Libelle,LibelleTec,LibelleCom,Numerotation : string; PVHT,TauxTva,QuantiteTot : Double; Unite : string);
  ...
  procedure TraiteLesLignes ( TOBFather : TOB; LIGNES : IXMLNode; TX :TDataTransport );
  var II : Integer;
  ...
  begin
    ...
    begin
      ...
      if NodeCur.NodeName = 'TYPELIG' then
      begin
      ...
      begin
        ...
        begin
          TraiteLesLignes (nil,NodeDetail,TX);
        end else if (TypeLig = 'C') then
        begin
          TOBpere := AjouteParagraphe (TOBFather,TX,Numerotation,Libelle);
          TraiteLesLignes (TOBpere,NodeDetail,TX);
        end;
      end;
    end;
    if TypeLig= 'A' then
    begin
      AjouteLigneDet (TOBfather,TX,CodeArticle,CodeBiblio,Libelle,LibelleTec,LibelleCom,Numerotation,PVHT,TauxTva,QuantiteTot,Unite);
    end;
