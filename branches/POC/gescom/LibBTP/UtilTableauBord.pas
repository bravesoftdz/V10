...
begin
  ...
  if (Pos(NaturePiece ,'FBT;B00;ABT;FAC;AVC;FBC;FBP;ABC;DAC')>0) Then
  begin
...
begin
  ...
  if (Pos(NaturePiece,'FBT;B00;FBP;FBC;DAC')>0) or (Pos(NaturePiece,'ABT;ABP;ABC')>0) or (NaturePiece = 'FAC') or (NaturePiece = 'AVC') Then
  begin
