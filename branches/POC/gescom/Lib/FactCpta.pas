...
Function PasseEnCompta ( TOBPiece,TOBOuvrages,TOBOuvragesP,TOBBases,TOBBasesST,TOBBasesCharge,TOBEches,TOBpieceTrait,TOBAFFInterv,TOBTiers,TOBArticles,TOBCpta,TOBAcomptes,TOBPorcs,TOBPieceRG,TOBBasesRG,TOBAnaP,TOBAnaS,TOBPieceinterv,TOBVTECOLL,TOBREPARTTVA : TOB ; NbDec : integer ; OldEcr : RMVT ; DEV : RDevise; NewPiece : Boolean; BAPPOC : Boolean=false) : T_RetCpta ;
Var
...
begin
  ...
  try
    ...
    if LastMsg > 0 then
    BEGIN
      MessageAlerte(TexteMessage[LastMsg]);
    END;
    //
    FreeAndNil(TobEcr);
