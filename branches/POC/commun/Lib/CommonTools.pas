...
{ Renvoie dans TSLResult le r�sultat du SELECT dont les valeurs sont s�par�es par des ^.
  Exemple de code pour appeler cette m�thode :
...
begin
  case CaseFromString(TableName, [  'CHOIXCOD', 'COMMUN'  , 'DEVISE'   , 'MODEREGL'     , 'PAYS'    , 'RIB'
                                  ...
                                  , 'AFFAIRE' , 'ARTICLE' , 'RESSOURCE', 'CONSOMMATIONS'
                                  , ''
                                 ]) of
...
begin
  ...
  RichEdit.Free;
  Panel.Free;
  // On remplace les saut de lignes et tabulations pour que �a passe dans le fichier d'�change (et pas de saut de ligne en fin de texte)
  if Result <> '' then
  begin
