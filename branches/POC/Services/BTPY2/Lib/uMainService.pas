...
begin
  AppPath := TServicesLog.GetServicesAppDataPath(True, 'ECHANGESY2');
  if AppPath <> '' then
  begin
        ...
        try
          ...
          begin
            ...
            begin
              ...
              if (TServicesLog.CanExecuteFromPeriod(BTPY2Exec.LogValues, ServiceName_BTPY2, ShowMsg)) and ((Count >= BTPY2Exec.SecondTimeout) or (FirstExec)) then
              begin
                FirstExec := False;
                Count     := 0;
                try
